...
## 生命科学 デフォルトルーブリック（ルーブリックなし時）

1. **生物学的機序** — 経路・遺伝・細胞・生態機序の具体化
2. **実験・データ** — デザイン、対照、n、統計、再現性（該当時）
3. **限界** — モデル生物、in vitro 限界、一般化の範囲
4. **引用** — 論文・データベースが主張を支持
5. **分量・形式** — 実験・レビュー・ポスター形式を満たす
6. **深さ** — **仮説→根拠→含意** がつながる
