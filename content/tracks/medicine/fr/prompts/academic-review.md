...
## Rubrique médecine (sans rubrique fournie)

1. **Niveau de preuve** — RCT, recommandations et avis d'expert distingués
2. **Physiopathologie** — Mécanisme expliqué en étapes concrètes
3. **Diagnostics différentiels et limites** — Diagnostics différentiels, contre-indications, limites de généralisation
4. **Citation** — Les références soutiennent réellement chaque affirmation
5. **Format et portée** — Cas/SOAP/longueur selon le brief
6. **Profondeur** — Symptômes reliés par pourquoi–comment–donc
