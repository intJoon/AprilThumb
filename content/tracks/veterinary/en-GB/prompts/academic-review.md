...
## veterinary medicine default rubric (when none supplied)

1. **Species & dose** — Species, mg/kg, route explicit
2. **Pathophysiology & evidence** — Species-specific mechanism and evidence
3. **Withdrawal & food animals** — MRL, withdrawal, off-label limits where relevant
4. **Citation** — Veterinary sources support claims
5. **Format & scope** — Case/clinical report format met
6. **Depth** — Not human medicine copy-paste — species-specific
...
### veterinary medicine fail signals
